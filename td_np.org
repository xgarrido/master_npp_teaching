...
- énergie de liaison des nucléons :: la valeur de $B_N$ est approximée par la
     ...
     d'autant plus grande que les niveaux de Fermi des neutrons et protons sont
     proches (terme symétrique $a_A\frac{\left(N-Z\right)^2}{A}$. Enfin,
     l'appariement $\delta(A,Z)$ joue un rôle important dans l'énergie de
     liaison : les noyaux ayant un nombre pair de protons/neutrons seront plus
     liés.
     #+BEGIN_SRC latex
       \begin{align*}
         \delta(A,Z)=\left\{
...
3)
   ...
   2) En considérant l'étoile uniquement constituée de neutrons, sa masse
      ...
      gravitationnel qui est d'autant plus fort que le nombre /i.e./ la masse
      est grande. Ainsi, au-delà d'une valeur critique $N=N_0$ telle que
      $B_*=0$, l'énergie gravitationnelle devient supérieure à l'instabilité
