...
- excès de masse atomique :: écart entre la masse atomique et la masse molaire
     ...
     #+BEGIN_SRC latex
        \begin{align*}
         ...
         \Delta M\left(^\text{A}_\text{Z}\text{X}\right)&=M_\text{at.}\left(^\text{A}_\text{Z}\text{X}\right) - A\text{ em u.m.a}\\
         \Delta M\left(^\text{A}_\text{Z}\text{X}\right)c^2&=M_\text{at.}\left(^\text{A}_\text{Z}\text{X}\right)c^2 - 931.5A\text{ em MeV}\\
       \end{align*}
     #+END_SRC
...
5)
   ...
   4) $t_0=\unit[1]{h}\ll T=\unit[2.6]{ans}$ d'où $\lambda t=\ln
      ...
      #+BEGIN_SRC latex
        \begin{align*}
          A(t)&=\lambda N(t)=\frac{\ln 2}{T}\times N(\unit[1]{h})\\
   ...
   5) La raie à 511 keV correspond aux photons issus de l'annihilation
      ...
      #+BEGIN_SRC latex
        \begin{align*}
          A_{\gamma_{0.511}}=2\times90\%\times A_{\gamma_{1.27}}=\unit[2846]{Bq}
        \end{align*}
      #+END_SRC
   6) Étant donné l'activité $A_{\gamma_{1.27}}=1581$ désintégrations par
      seconde dans tout l'espace soit 4\pi stéradian, le nombre de photons
      détectés à 1 m de la cible devient
      #+BEGIN_SRC latex
        \begin{align*}
          N_{\gamma_{1.27}}(\text{détectés/min})&=A_{\gamma_{1.27}}\times60\times\frac{S}{4\pi d^2}\\
