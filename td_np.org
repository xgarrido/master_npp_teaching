...
** Les mésons $D$
#+BEGIN_QUESTION
Soit le méson $D^0$, ayant pour caracténauristiques : $mc^2$ = 1865 MeV, $I^{\pi}
...
5) [@5] On observe la désintégration $D^0 \rightarrow K^- + \pi^+$. En utilisant
   ...
   à l'appui de cette réponse. On donne pour les kaons et les pions : I$^{\pi}$
   = 0$^-$.
#+END_QUESTION
...
10) [@10] On attribue à la particule $X$ les caractéristiques : $I^{\pi}$ =
    1^{-}, $T$ = 1/2, $T_{3}$ = 1/2. Quelle est sa composition en quarks ?
    Préciser les valeurs possibles du moment orbital relatif $\vv{L}$ et du spin
    $\vv{S}$.
#+END_QUESTION
