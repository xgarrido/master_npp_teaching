   ...
   2)
      ...
      2)
         ...
         - la levée de dégénérescence due à l'interaction résiduelle
           ...
           $\hat{H}=\hat{H}_0+\hat{V}_\text{res.}$ : l'interaction résiduelle
           entre $p-p$ est plus importante qu'entre $p-n$ expliquant l'écart
           d'énergie $\Delta E$ entre les niveaux excités : 3.6 MeV
