...
1) \nbsp^{2}_{1}H+\nbsp^{63}_{29}Cu\to\nbsp^{2}_{1}H+\nbsp^{63}_{29}Cu
   #+BEGIN_SRC latex
     ...
     \end{align*}
   #+END_SRC
   où $\phi=\phi'\pi R^2$ et $\phi'=\unit[6\,10^{10}]{s^{-1}.cm^{-2}}$. Le
...
3)
   1) La luminosité $\mathcal{L}$ s'exprime comme le rapport du nombre de
      ...
      #+BEGIN_SRC latex
        \begin{align*}
          ...
          &=\unit[6.63\,10^{34}]{m^2s^{-1}}=\unit[6.63\,10^{30}]{cm^2s^{-1}}
        \end{align*}
      #+END_SRC
   2) Diffusion [[http://en.wikipedia.org/wiki/Homi_J._Bhabha][Bhabha]] $e^+e^-\to e^+e^-$
      ...
      2) Le nombre d'interaction par seconde est
         ...
         #+BEGIN_SRC latex
           \begin{align*}
             \mathcal{L}=\frac{n}{\sigma}=\frac{0.2639}{4\,10^{36}}=\unit[6.553\,10^{34}]{m^{-2}s^{-1}}
           \end{align*}
         #+END_SRC
...
1) $n_\text{th.}+^{10}_{5}\text{B}\rightarrow\alpha+^{7}_{3}\text{Li}$
   ...
   #+BEGIN_SRC latex
     ...
     \end{align*}
   #+END_SRC
   La réaction est donc exoénergétique ou spontanée et ne suppose donc pas
   nécessairement d'énergie cinétique pour les neutrons
   $T_{n_\text{th.}}\ll1\sim0$. On considèrera donc la réaction se faisant au
   repos $T_{n_\text{th.}}=T_{^{10}_{5}\text{B}}\sim0$. La conservation de
   l'impulsion implique donc que $\vv{p}_\alpha=-\vv{p}_{^{7}_{3}\text{Li}}$
   soit
   #+BEGIN_SRC latex
     \begin{align*}
   ...
   #+BEGIN_SRC latex
     \begin{align*}
       ...
       T_\alpha&=\frac{Q^2-2Qm_{^{7}_{3}\text{Li}}c^2}{3\left(m_n c^2+m_{^{10}_{5}\text{B}}c^2\right)}\\
       &=\unit[1.8]{MeV}
     \end{align*}
   #+END_SRC
...
3) Le nombre de particules \alpha détectées se déduit de l'expression suivante
   ...
   de surface est donc $F=\frac{\phi}{S_\text{cible}}=\unit[2\,10^6]{cm^{-2}.s^{-1}}$.
