...
4) Calcul du nombre de neutrinos
   ...
   #+BEGIN_SRC latex
     \begin{align*}
       N_\nu&=\frac{\Gamma_\text{tot.}(Z^0)-N_l\Gamma(Z^0\to \ell^-\ell^+)-\Gamma_\text{tot.}(Z^0\to q\bar{q})}{\Gamma(Z^0\to\nu\bar{\nu})}\\
       &=\frac{\Gamma_\text{tot.}(Z^0)-N_l\Gamma(Z^0\to \ell^-\ell^+)-\Gamma_\text{tot.}(Z^0\to q\bar{q})}{\alpha_\text{em}\,M_{Z^0}c^2}\times24\sin^2\theta_W\cos^2\theta_W\\
...
3) Du fait que $\Updelta t\leq\unit[10]{s}$, on déduit que la masse des neutrinos $m_\nu$
   ...
   Mainz and Troitztk, ont abaissé cette limite à
   $m_{\nu_e}\leq\unit[2.2]{eV}$. La future expérience Katrin devait gagner
   encore un ordre de grandeur sur la sensibilité :
   $m_{\nu_e}\leq\unit[0.2]{eV}$.
...
1) Les états "fictifs" $\ket{K^0_1}$ et $\ket{K^0_2}$ sont des états propres de
   ...
   propres $\ket{K^0_1}$ et $\ket{K^0_2}$ et se déintégrant aussi bien en deux
...
2) Soit un faisceau de particules de vitesse $v=\beta c$, de vie moyenne $\tau$
   ...
   2) Faisceau de $K^0$ à $p=\unit[10]{GeV/c}$. Initialement, le faisceau est
      donc constitué pour moitié de "particules" $K_1^0$ et de "particules"
      $K_2^0$. On suppose par ailleurs que la masse et l'impulsion de ces
