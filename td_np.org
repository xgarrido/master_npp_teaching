...
- énergie de liaison des nucléons :: la valeur de $B_N$ est approximée par la
     ...
     de l'énergie de liaison. De plus, l'énergie potentiellle du noyau sera
...
1) La variation du nombre de noyaux de carbone 11, $\frac{dn}{dt}$, est égale à
   ...
   #+BEGIN_SRC latex
     \begin{align*}
       n(t=\unit[3]{h})=&\frac{4\,10^{12}\times10\,10^{-3}\times6.02\,10^{23}\times200\,10^{-24}}{\ln 2\times14}\\
       &\times20.36\times60\times\left(1-e^{-\frac{\ln 2\times3\times60}{20.36}}\right)\\
...
2) À $t=t_0=\unit[3]{h}$, l'irradiation est stoppée, les noyaux de carbone ne
   ...
   #+BEGIN_SRC latex
     \begin{align*}
       ...
       &=\unit[1.24\,10^8]{Bq}=\unit[3.3]{mCi}
     \end{align*}
   #+END_SRC
...
3)
   1) Pour une étoile à neutrons, l'énergie de liaison devient ($Z=0$)
      #+BEGIN_SRC latex
        \begin{align*}
          ...
          &\text{ avec }A=Z+N=N\quad B_N=a_VN-a_ZN^{2/3}-a_A\frac{N^{\cancel{2}}}{\cancel{N}}\\
          B_N&=\left(a_V-a_A\right)N-a_SN^{2/3}
        \end{align*}
      #+END_SRC
   ...
   2) En considérant l'étoile uniquement constituée de neutrons, sa masse
      ...
      #+BEGIN_SRC latex
        ...
        \end{align*}
      #+END_SRC
      Le rayon minimal d'une étoile à neutron est donc
      #+BEGIN_SRC latex
        \begin{align*}
...
1) Désintégrations isobariques (\beta^{-}, \beta^{+}, CE)
   ...
   - capture électronique ::
        ...
        #+BEGIN_SRC latex
          \begin{align*}
            Q>0 \Longleftrightarrow\,& m(A,Z)c^2+m_exc^2>m(A,Z-1)c^2\\
...
2) Le diagramme $M_\text{at.}c^2=f(Z)$ ou $\Delta M_\text{at.}c^2=f(Z)$ pour une
   ...
   $Z$ prend la forme du parabole car
   #+BEGIN_SRC latex
     \begin{align*}
...
3) D'après la figure [[mass_parabola]], les désintégrations \beta^{-} sont Cr\to
   ...
   - $^{58}_{24}Cr\to ^{58}_{25}Mn+e^-+\bar{\nu}_e$
     #+BEGIN_SRC latex
       \begin{align*}
         Q_{\beta^-}& = \Delta M(^{58}_{24}Cr)c^2-\Delta M(^{58}_{25}Mn)c^2\\
         &=\unit[3.78]{MeV}=T_\text{max}(e^-)
       \end{align*}
     #+END_SRC
   - $^{58}_{25}Mn\to ^{58}_{26}Fe+e^-+\bar{\nu}_e$
     #+BEGIN_SRC latex
       \begin{align*}
         Q_{\beta^-}& = \Delta M(^{58}_{25}Mn)c^2-\Delta M(^{58}_{26}Fe)c^2\\
         &=\unit[6.32]{MeV}=T_\text{max}(e^-)
       \end{align*}
     #+END_SRC
   - $^{58}_{27}Co\to ^{58}_{28}Ni+e^-+\bar{\nu}_e$
     #+BEGIN_SRC latex
       \begin{align*}
         Q_{\beta^-}& = \Delta M(^{58}_{27}Co)c^2-\Delta M(^{58}_{28}Ni)c^2\\
         &=\unit[0.38]{MeV}=T_\text{max}(e^-)
       \end{align*}
     #+END_SRC

   - $^{58}_{30}Zn+e^-\to ^{58}_{29}Cu+\nu_e$
     #+BEGIN_SRC latex
       \begin{align*}
         Q_\text{CE}& = \Delta M(^{58}_{30}Zn)c^2-\Delta M(^{58}_{29}Cu)c^2\\
         &=\unit[9.45]{MeV}\\
         Q_{\beta^+}&=Q_\text{CE} - 2m_ec^2=\unit[8.48]{MeV}=T_\text{max}(e^+)
       \end{align*}
     #+END_SRC
   - $^{58}_{29}Cu+e^-\to ^{58}_{28}Ni+\nu_e$
     #+BEGIN_SRC latex
       \begin{align*}
         Q_\text{CE}& = \Delta M(^{58}_{29}Cu)c^2-\Delta M(^{58}_{28}Ni)c^2\\
         &=\unit[8.56]{MeV}\\
         Q_{\beta^+}&=Q_\text{CE} - 2m_ec^2=\unit[7.54]{MeV}=T_\text{max}(e^+)
       \end{align*}
     #+END_SRC
   - $^{58}_{27}Co+e^-\to ^{58}_{26}Fe+\nu_e$
     #+BEGIN_SRC latex
       \begin{align*}
         Q_\text{CE}& = \Delta M(^{58}_{27}Co)c^2-\Delta M(^{58}_{26}Fe)c^2\\
         &=\unit[2.31]{MeV}\\
...
aller-retour. Les effets d'une cigarette sont eux évalué à 0.01 mSv par
